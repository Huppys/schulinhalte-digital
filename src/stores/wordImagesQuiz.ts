...
export const useReadingWordImagesQuizStore = defineStore(
  "readingWordImagesQuiz",
  () => {
    const localStorageReadingKey: string = "Lesen";
    let localStorageReading: string | null = localStorage.getItem(
      localStorageReadingKey
    );
