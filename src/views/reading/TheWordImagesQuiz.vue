...
import {
  WordImageQuiz,
  WordImagesQuizHelper,
} from "@/components/reading/wordImagesQuizHelper";
...
const currentQuiz: ComputedRef<WordImageQuiz> = computed(
  () => wordImageQuiz[index.value]
);
...
function submitResult() {
  ...
  if (
    mathe1x1Helper.multiply(firstFactor.value, secondFactor.value) ===
